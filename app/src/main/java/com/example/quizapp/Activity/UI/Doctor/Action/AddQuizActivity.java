...
public class AddQuizActivity extends AppCompatActivity {
    ...
    void addQuestion() {
        ...
        question.setQuestionID(String.valueOf(questions.size()));
        ...
        binding.choose1.setText("");
        binding.choose2.setText("");
        binding.choose3.setText("");
        binding.choose4.setText("");
    ...
    void saveQuiz() {
        ...
        saveQuizBinding.saveQuiz.setOnClickListener(v -> {
            ...
            modelQuiz.setUserID(currentUser.getUid());
            modelQuiz.setQuizID(refQuizzes.push().getKey());
